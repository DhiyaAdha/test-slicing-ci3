...
<head>
    ...
    <title>Transactions StoreGG</title>
</head>
                ...
                <div class="menus">
                    <div class="item mb-30">
                        ...
                        <p class="item-title m-0">
                            <a href="<?php echo base_url('welcome/main')?>" class="text-lg text-decoration-none">Overview</a>
                        </p>
                    </div>
                    <div class="item active mb-30">
                        ...
                        <p class="item-title m-0">
                            <a href="" class="text-lg text-decoration-none">Transactions</a>
                        </p>
                    </div>
                    <div class="item mb-30">
                        <svg class="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-lg-12 col-12 main-content">
                        <div id="list_status_title">
                            <a data-filter="*" href="#" class="btn btn-status rounded-pill text-sm btn-active me-3">All
                                Trx</a>
                            <a data-filter="success" href="#" class="btn btn-status rounded-pill text-sm me-3">Success</a>
                            <a data-filter="pending" href="#" class="btn btn-status rounded-pill text-sm me-3">Pending</a>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody id="list_status_item">
                                <tr data-category="pending" class="align-middle">
                                    ...
                                    <td>
                                        <a href="../member/transactions-detail.html" class="btn btn-status rounded-pill text-sm">Details</a>
                                    </td>
                                </tr>
