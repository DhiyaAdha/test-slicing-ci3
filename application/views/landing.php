            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto text-lg gap-lg-0 gap-2">
                        ...
                        <li class="nav-item my-auto">
                            <a class="btn btn-sign-in d-flex justify-content-center ms-lg-2 rounded-pill" href="./src/sign-in.html" role="button">Sign
                                In</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row gap-lg-0 gap-5">
                <div class="col-lg-6 col-12 my-auto">
                    ...
                    <h1 class="header-title color-palette-1 fw-bold">
                        ...
                        </span><span class="underline-blue"> New</span> <br class="d-sm-block d-none"> <span class="underline-blue">Experience</span> in Gaming
                    </h1>
                    <p class="mt-30 mb-40 text-lg color-palette-1">Kami menyediakan jutaan cara untuk membantu<br class="d-md-block d-none"> players menjadi pemenang sejati
                    </p>
                ...
                <div class="col-lg-6 col-12 d-lg-block d-none">
                    <div class="d-flex justify-content-lg-end justify-content-center me-lg-5">
                        <div class="position-relative" data-aos="zoom-in">
                            <img src="<?php echo base_url('assets/img/Header-1.png') ?>" class="img-fluid" alt="">
                            <div class="card left-card position-absolute border-0">
                                <div class="d-flex align-items-center mb-16 gap-3">
                                    <img src="./assets/img/Header-2.png" width="40" height="40" class="rounded-pill" alt="">
                                    <img src="<?php echo base_url('assets/img/Header-2.png') ?>" width="40" height="40" class="rounded-pill" alt="">
                                    <div>
                            ...
                            <div class="card right-card position-absolute border-0">
                                <div class="position-relative d-flex flex-row justify-content-center mb-24">
                                    <img src="<?php echo base_url('assets/img/Header-3.png') ?>" class="rounded-pill" alt="">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex flex-row flex-lg-wrap overflow-setting justify-content-lg-between gap-lg-3 gap-4" data-aos="fade-up">
                <div class="featured-game-card position-relative">
                    <a href="./src/detail.html">
                        <div class="blur-sharp">
                            <img src="<?php echo base_url('assets/img/Thumbnail-1.png') ?>" width="205" height="270" alt="">
                        </div>
                ...
                <div class="featured-game-card position-relative">
                    <a href="./src/detail.html">
                        <div class="blur-sharp">
                            <img src="<?php echo base_url('assets/img/Thumbnail-2.png') ?>" width="205" height="270" alt="">
                        </div>
                        <div class="cover position-absolute bottom-0 m-32">
                            <div class="d-flex flex-column h-100 justify-content-between text-decoration-none">
                                <div class="game-icon mx-auto">
                    ...
                    <div class="col-lg-8 mt-lg-0 mt-20">
                        <div class="row gap-sm-0">
                            ...
                            <div class="col-md-4 col-12 mt-lg-0 mt-md-0 mt-25">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-6">
                                        <a href="mailto: hi@store.gg" class="text-lg color-palette-1 text-decoration-none">hi@store.gg</a>
                                    </li>
                                    <li class="mb-6">
                                        <a href="mailto: team@store.gg" class="text-lg color-palette-1 text-decoration-none">team@store.gg</a>
                                    </li>
                                    <li class="mb-6">
                                    ...
                                    <li class="mb-6">
                                        <a href="tel: 02111229090" class="text-lg color-palette-1 text-decoration-none">021 - 1122 -
                                            9090</a>
                                    </li>
                                </ul>
                            </div>
