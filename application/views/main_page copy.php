        ...
        <section class="sidebar">
            <div class="content pt-50 pb-30 ps-30">
                <div class="user text-center pb-50 pe-30">
                    <img src="<?php echo base_url('assets/img/avatar-1.png'); ?>" width="90" height="90" class="img-fluid mb-20" />
                ...
                <div class="menus">
                    ...
                    <div class="item mb-30">
                        ...
                        <p class="item-title m-0">
                            <a href="<?php echo base_url('welcome/transaction')?>" class="text-lg text-decoration-none">Transactions</a>
                        </p>
                    </div>
                    <div class="item mb-30">
                        <svg class="icon me-3" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="sidebar-footer pt-73 pe-30">
                    <div class="footer-card">
                        ...
                        <a class="btn btn-get-started w-100 fw-medium text-xs text-center text-white rounded-pill" href="#" role="button">Get Started</a>
                    </div>
                </div>
            </div>
        </section>
